<?php
    ...
    if(isset($_POST['update_hotel'])) 
    {
      ...
      {
        echo "<p class='text-center alert alert-success' role='alert'>Hotel Details Updated Successfully: <a href='includes/hotel_images_add.php?hotel_id={$get_hotel_id}'>Add Images </a> or <a href='hotels.php'>View All Hotels</a></p>";
      }
    }
?>
...
<form id="frmAddHotel" action="" method="post" enctype="multipart/form-data">
