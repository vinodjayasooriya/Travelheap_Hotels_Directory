...
<?php
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		if($status == "CheckOut")
		{
			...
			// Approve
			// echo "<td><a class='btn btn-sm btn-warning' href='reservations.php?source=checkin_reservations&check_out={$reservation_id}'>Check Out</a></td>";
...
<?php
 ...
 //    	$get_check_out_id = $_GET['check_out'];
	...
	//     header("Location: reservations.php?source=checkin_reservations");
	// }
