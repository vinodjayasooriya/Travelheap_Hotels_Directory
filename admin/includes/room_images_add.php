...
?>    
  <h3 align="center">Images of <?php echo $room_type; ?> Room 
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-lg-4 bg-dark rounded px-4">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <!-- <a class="btn btn-danger btn-block" onClick="javascript: return confirm('Are you sure you want to delete all the images?'); " href="room_images_add.php?delete=<?php echo $get_room_id; ?>">Delete Images</a> -->

          <a class="btn btn-danger btn-block" onClick="javascript: return confirm('Are you sure you want to delete all the images?'); " href="room_images_add.php?room_id=<?php echo $get_room_id; ?>&hotel_id=<?php echo $get_hotel_id; ?>&delete=<?php echo $get_room_id; ?>">Delete Images</a>
...
<?php
  if(isset($_GET['delete']))
  {
   $get_room_if_delete = $_GET['delete']; 
    ...
    {
      header("Location: room_images_add.php?room_id={$get_room_id}&hotel_id={$get_hotel_id}");        
    }
  }
?>
