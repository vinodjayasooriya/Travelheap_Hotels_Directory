...
<form action="" method="post" enctype="multipart/form-data">
    <a href="hotels.php?source=edit_hotel_room&room_id=<?php echo $get_room_id; ?>">View Rooms</a>
    or 
    <a href="includes/hotel_room_images_add.php?room_id=<?php echo $get_room_id; ?>&hotel_id=<?php echo $get_hotel_id; ?>">Add Images</a>
<?php
...
?>
    <h3 class="text-center mb-0"><?php echo $hotel_name; ?></h3>

    <h5 class="text-center text-secondary mt-2 mb-4">Available Amenities</h5>
        <div class="row">
            <?php 
    ...
    <h5 class="text-center mt-5 mb-4 text-secondary">Selected Amenities</h5>
        <div class="row">
<?php
...
?>
        ...
        <div class="col-lg-3">
            <label><img src='images/amenities/<?php echo $image; ?>'> <?php echo $amenities; ?> <a class="btn-danger" href="hotels.php?source=add_amenities_to_hotel_rooms&room_id=<?php echo $get_room_id; ?>&hotel_id=<?php echo $get_hotel_id; ?>&delete=<?php echo $db_id; ?>"> X </a> </label> 
        </div>
...
if(isset($_GET['delete']))
{
    ...
    else
    {
        ...
        header ("Location: hotels.php?source=add_amenities_to_hotel_rooms&room_id={$get_room_id}&hotel_id={$get_hotel_id}");
    }
}
