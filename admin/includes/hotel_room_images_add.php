...
function make_slides($conn)
{
 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  $output .= '
   <img width="80%" style="padding-left: 100px;"  height="80%" src="../images/rooms/'.$row["image"].'"/>
...
?>    
  <h3 align="center">Images of <?php echo $room_type; ?> Room <a href="../hotels.php?source=edit_hotel_room&room_id=<?php echo $room_id; ?>"> View Room Details</a> or <a href="../hotels.php?source=view_hotel_rooms&hotel_id=<?php echo $db_hotel_id; ?>"> View All Rooms</a>
  </h3>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-lg-4 bg-dark rounded px-4">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <a class="btn btn-danger btn-block" onClick="javascript: return confirm('Are you sure you want to delete all the images?'); " href="hotel_room_images_add.php?room_id=<?php echo $get_room_id; ?>&hotel_id=<?php echo $get_hotel_id; ?>&delete=<?php echo $get_room_id; ?>">Delete Images</a>
        </div>
      </form>
    </div>
    <div class="col-lg-4"></div>
...
<?php
  if(isset($_GET['delete']))
  {
   $get_room_if_delete = $_GET['delete']; 
    ...
    {
      header("Location: hotel_room_images_add.php?room_id={$get_room_id}&hotel_id={$db_hotel_id}");        
    }
  }
?>
