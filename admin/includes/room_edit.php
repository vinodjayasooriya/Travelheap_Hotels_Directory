<?php
    ...
    if(isset($_POST['update_room']))
    {
        ...
        <a href='rooms.php?source=add_amenities_to_rooms&room_id={$get_room_id}&hotel_id={$hotel_id}'>Add Amenities </a> 
        or
        <a href='includes/room_images_add.php?room_id={$get_room_id}&hotel_id={$hotel_id}'>Add Images </a> 
        or
        <a href='../room-single.php?room_id={$get_room_id}'>View Room Details </a> 
        or 
        <a href='rooms.php'>View All Rooms</a></p>";
        }
