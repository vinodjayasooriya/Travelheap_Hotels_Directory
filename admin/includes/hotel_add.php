...
$result_insert = mysqli_query($conn, $query_insert);
    if (!$result_insert)
    {
        ...
        echo "<p class='text-center alert alert-success' role='alert'>Hotel Created Successfully: <a href='includes/hotel_images_add.php?hotel_id={$hotel_id}'>Add Images</a> or <a href='hotels.php'>View All Hotels</a></p>";
    }
}
