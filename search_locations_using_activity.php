...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="col-lg-9">
            <div class="row">
<?php
    if(isset($_POST['search_loc_using_activity']))
    {
        $activity_id   = $_POST['activity'];

        $query_search = "SELECT * FROM tbl_locations LEFT JOIN tbl_location_activities ON tbl_locations.loc_id = tbl_location_activities.location_id WHERE tbl_location_activities.activity_id LIKE '%$activity_id%' ";
