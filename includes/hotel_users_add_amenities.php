...
<form action="" method="post" enctype="multipart/form-data">
        <h4 class="text-center mb-3">Amenities</h4>
        <div class="row">
            <?php 
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <label><input  type='checkbox' name='amenities_id[]' value="<?php echo $am_id; ?>"><img src='admin/images/amenities/<?php echo $image; ?>' alt=''><?php echo $amenities; ?></label>
            </div>
...
header ("Location: index_hotel_users.php?source=add_amenities&room_id={$get_room_id}&hotel_id={$get_hotel_id}");
    }
}
...
?>
    ...
    <h4 class="text-center my-5">Selected Amenities</h4>
        <div class="row">
<?php
...
?>
                ...
                <div class="col-lg-3">
                    <label><img src='admin/images/amenities/<?php echo $image; ?>'> <?php echo $amenities; ?> <a class="btn-danger btn btn-sm" href="index_hotel_users.php?source=add_amenities&room_id=<?php echo $get_room_id; ?>&hotel_id=<?php echo $get_hotel_id; ?>&delete=<?php echo $db_id; ?>"> X </a> </label> 
                </div> 
